...
class IS2Database:
    ...
    def query_photons(
        ...
        Args:
            ...
            omit_bboxes : list, tuple, or None
                Bounding box(es) whose photons are dropped from the results. Accepts a
    ...
    def unique_bboxes(
        ...
        Args:
            gdf : pandas.DataFrame, optional
                An already-loaded granule index to read the boxes from. When None
