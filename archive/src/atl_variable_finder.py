...
def accrue_variables(var_id_list, dataset_name="ATL03", return_type=list, str_sep="\n"):
    ...
    var_dict = {
        "ATL03": ATL03_var_dict,
        "ATL06": ATL06_var_dict,
        "ATL08": ATL08_var_dict,
    }[dataset_name]
...
ATL03_var_dict = {
    ...
    "altimetry": ["/ancillary_data/altimetry"],
    "altitude_sc": [
    ...
    "atl03_pad": ["/ancillary_data/altimetry/atl03_pad"],
    "atlas_engineering": ["/ancillary_data/atlas_engineering"],
    "atlas_impulse_response": ["/atlas_impulse_response"],
    "atlas_sdp_gps_epoch": ["/ancillary_data/atlas_sdp_gps_epoch"],
    "band_tol": ["/ancillary_data/altimetry/band_tol"],
    "bckgrd_atlas": [
        "/gt1l/bckgrd_atlas",
        "/gt1r/bckgrd_atlas",
        "/gt2l/bckgrd_atlas",
    ...
    "bin_width": ["/ancillary_data/calibrations/low_link_impulse_response/bin_width"],
    "bounce_time_offset": [
    ...
    "cal19_product": ["/ancillary_data/calibrations/first_photon_bias/cal19_product"],
    "cal20_product": [
    ...
    "cal42_product": ["/ancillary_data/calibrations/dead_time/cal42_product"],
    "calibrations": ["/ancillary_data/calibrations"],
    ...
    "det_ab_flag": ["/ancillary_data/atlas_engineering/det_ab_flag"],
    "dist_ph_across": [
    ...
    "ds_channel": ["/ancillary_data/calibrations/ds_channel"],
    "ds_gt": ["/ancillary_data/atlas_engineering/ds_gt", "/ancillary_data/tep/ds_gt"],
    "ds_stat": ["/ancillary_data/atlas_engineering/ds_stat"],
    ...
    "hist_x": ["/ancillary_data/calibrations/low_link_impulse_response/hist_x"],
    "htspanmin": [
    ...
    "hvpc_ab_flag": ["/ancillary_data/atlas_engineering/hvpc_ab_flag"],
    "inlandwater": [
    ...
    "laser": ["/ancillary_data/calibrations/low_link_impulse_response/laser"],
    "laser_12_flag": ["/ancillary_data/atlas_engineering/laser_12_flag"],
    "lat_ph": [
        "/gt1l/heights/lat_ph",
        "/gt1r/heights/lat_ph",
        "/gt2l/heights/lat_ph",
    ...
    "lrs_ab_flag": ["/ancillary_data/atlas_engineering/lrs_ab_flag"],
    "lslant_flag": [
    ...
    "min_full_sat": ["/ancillary_data/altimetry/min_full_sat"],
    "min_near_sat": ["/ancillary_data/altimetry/min_near_sat"],
    "min_sat_h": ["/ancillary_data/altimetry/min_sat_h"],
    "min_tep_ph": ["/ancillary_data/tep/min_tep_ph"],
    "min_tep_secs": ["/ancillary_data/tep/min_tep_secs"],
    "mode": ["/ancillary_data/calibrations/low_link_impulse_response/mode"],
    "n_delta_z1": [
    ...
    "n_tep_bins": ["/ancillary_data/tep/n_tep_bins"],
    "nbin_min": [
    ...
    "num_bins": ["/ancillary_data/calibrations/low_link_impulse_response/num_bins"],
    "ocean": [
    ...
    "pce1_spot1": ["/atlas_impulse_response/pce1_spot1"],
    "pce2_spot3": ["/atlas_impulse_response/pce2_spot3"],
    "pce_mframe_cnt": [
    ...
    "pdu_ab_flag": ["/ancillary_data/atlas_engineering/pdu_ab_flag"],
    "ph_id_channel": [
    ...
    "ph_sat_flag": ["/ancillary_data/altimetry/ph_sat_flag"],
    "ph_sat_lb": ["/ancillary_data/altimetry/ph_sat_lb"],
    "ph_sat_ub": ["/ancillary_data/altimetry/ph_sat_ub"],
    ...
    "podppd_pad": ["/ancillary_data/altimetry/podppd_pad"],
    ...
    "receiver": ["/ancillary_data/atlas_engineering/receiver"],
    "ref_azimuth": [
    ...
    "spd_ab_flag": ["/ancillary_data/atlas_engineering/spd_ab_flag"],
    ...
    "tep_normalize": ["/ancillary_data/tep/tep_normalize"],
    "tep_peak_bins": ["/ancillary_data/tep/tep_peak_bins"],
    "tep_prim_window": ["/ancillary_data/tep/tep_prim_window"],
    "tep_range_prim": ["/ancillary_data/tep/tep_range_prim"],
    "tep_rm_noise": ["/ancillary_data/tep/tep_rm_noise"],
    "tep_sec_window": ["/ancillary_data/tep/tep_sec_window"],
    "tep_start_x": ["/ancillary_data/tep/tep_start_x"],
    "tep_tod": [
        "/atlas_impulse_response/pce1_spot1/tep_histogram/tep_tod",
        "/atlas_impulse_response/pce2_spot3/tep_histogram/tep_tod",
    ],
    "tep_valid_spot": ["/ancillary_data/tep/tep_valid_spot"],
    "tide_earth": [
    ...
    "transmit": ["/ancillary_data/atlas_engineering/transmit"],
...
ATL06_var_dict = {
    ...
    "lan": ["/orbit_info/lan"],
    "land_ice": ["/ancillary_data/land_ice"],
    "land_ice_segments": [
    ...
    "txp_maxiter": ["/ancillary_data/land_ice/txp_maxiter"],
    "version": ["/ancillary_data/version"],
...
ATL08_var_dict = {
    ...
    "atl08_region": ["/ancillary_data/land/atl08_region"],
    "atlas_pa": [
    ...
    "bin_size_h": ["/ancillary_data/land/bin_size_h"],
    "bin_size_n": ["/ancillary_data/land/bin_size_n"],
    "bright_thresh": ["/ancillary_data/land/bright_thresh"],
    "brightness_flag": [
    ...
    "ca_class": ["/ancillary_data/land/ca_class"],
    "can_noise_thresh": ["/ancillary_data/land/can_noise_thresh"],
    "can_stat_thresh": ["/ancillary_data/land/can_stat_thresh"],
    "canopy": [
    ...
    "canopy_flag_switch": ["/ancillary_data/land/canopy_flag_switch"],
    "canopy_h_metrics": [
    ...
    "canopy_seg": ["/ancillary_data/land/canopy_seg"],
    "centroid_height": [
    ...
    "class_thresh": ["/ancillary_data/land/class_thresh"],
    "classed_pc_flag": [
    ...
    "cloud_filter_switch": ["/ancillary_data/land/cloud_filter_switch"],
    "cloud_flag_atm": [
    ...
    "data_end_utc": ["/ancillary_data/data_end_utc"],
    "data_start_utc": ["/ancillary_data/data_start_utc"],
    "del_amp": ["/ancillary_data/land/del_amp"],
    "del_mu": ["/ancillary_data/land/del_mu"],
    "del_sigma": ["/ancillary_data/land/del_sigma"],
    "delta_time": [
    ...
    "dem_filter_switch": ["/ancillary_data/land/dem_filter_switch"],
    "dem_flag": [
    ...
    "dem_removal_percent_limit": ["/ancillary_data/land/dem_removal_percent_limit"],
    "dragann_switch": ["/ancillary_data/land/dragann_switch"],
    "ds_geosegments": ["//ds_geosegments"],
    "ds_metrics": ["//ds_metrics"],
    "ds_surf_type": ["//ds_surf_type"],
    "dseg": ["/ancillary_data/land/dseg"],
    "dseg_buf": ["/ancillary_data/land/dseg_buf"],
    "end_cycle": ["/ancillary_data/end_cycle"],
    "end_delta_time": ["/ancillary_data/end_delta_time"],
    "end_geoseg": ["/ancillary_data/end_geoseg"],
    "end_gpssow": ["/ancillary_data/end_gpssow"],
    ...
    "end_region": ["/ancillary_data/end_region"],
    "end_rgt": ["/ancillary_data/end_rgt"],
    "fnlgnd_filter_switch": ["/ancillary_data/land/fnlgnd_filter_switch"],
    "gnd_stat_thresh": ["/ancillary_data/land/gnd_stat_thresh"],
    "granule_end_utc": ["/ancillary_data/granule_end_utc"],
    "granule_start_utc": ["/ancillary_data/granule_start_utc"],
    "gthresh_factor": ["/ancillary_data/land/gthresh_factor"],
    "h_canopy": [
    ...
    "h_canopy_perc": ["/ancillary_data/land/h_canopy_perc"],
    "h_canopy_quad": [
    ...
    "iter_gnd": ["/ancillary_data/land/iter_gnd"],
    "iter_max": ["/ancillary_data/land/iter_max"],
    "lan": ["/orbit_info/lan"],
    "land": ["/ancillary_data/land"],
    "land_segments": [
        "/gt1l/land_segments",
        "/gt1r/land_segments",
        "/gt2l/land_segments",
    ...
    "lseg": ["/ancillary_data/land/lseg"],
    "lseg_buf": ["/ancillary_data/land/lseg_buf"],
    "lw_filt_bnd": ["/ancillary_data/land/lw_filt_bnd"],
    "lw_gnd_bnd": ["/ancillary_data/land/lw_gnd_bnd"],
    "lw_toc_bnd": ["/ancillary_data/land/lw_toc_bnd"],
    "lw_toc_cut": ["/ancillary_data/land/lw_toc_cut"],
    "max_atl03files": ["/ancillary_data/land/max_atl03files"],
    "max_atl09files": ["/ancillary_data/land/max_atl09files"],
    "max_peaks": ["/ancillary_data/land/max_peaks"],
    "max_try": ["/ancillary_data/land/max_try"],
    "min_nphs": ["/ancillary_data/land/min_nphs"],
    "msw_flag": [
    ...
    "n_dec_mode": ["/ancillary_data/land/n_dec_mode"],
    "n_seg_ph": [
    ...
    "night_thresh": ["/ancillary_data/land/night_thresh"],
    "noise_class": ["/ancillary_data/land/noise_class"],
    "orbit_info": ["/orbit_info"],
    "orbit_number": ["/orbit_info/orbit_number"],
    "outlier_filter_switch": ["/ancillary_data/land/outlier_filter_switch"],
    "p_static": ["/ancillary_data/land/p_static"],
    "ph_h": [
    ...
    "ph_removal_percent_limit": ["/ancillary_data/land/ph_removal_percent_limit"],
    "ph_segment_id": [
    ...
    "proc_geoseg": ["/ancillary_data/land/proc_geoseg"],
    "psf": ["/ancillary_data/land/psf"],
    "psf_flag": [
    ...
    "ref_dem_limit": ["/ancillary_data/land/ref_dem_limit"],
    "ref_finalground_limit": ["/ancillary_data/land/ref_finalground_limit"],
    "release": ["/ancillary_data/release"],
    "relief_hbot": ["/ancillary_data/land/relief_hbot"],
    "relief_htop": ["/ancillary_data/land/relief_htop"],
    "rgt": [
    ...
    "shp_param": ["/ancillary_data/land/shp_param"],
    "sig_rsq_search": ["/ancillary_data/land/sig_rsq_search"],
    "sigma_across": [
    ...
    "start_region": ["/ancillary_data/start_region"],
    "start_rgt": ["/ancillary_data/start_rgt"],
    "stat_thresh": ["/ancillary_data/land/stat_thresh"],
    "subset_can_flag": [
    ...
    "tc_thresh": ["/ancillary_data/land/tc_thresh"],
    "te_class": ["/ancillary_data/land/te_class"],
    "terrain": [
    ...
    "toc_class": ["/ancillary_data/land/toc_class"],
    "toc_roughness": [
    ...
    "up_filt_bnd": ["/ancillary_data/land/up_filt_bnd"],
    "up_gnd_bnd": ["/ancillary_data/land/up_gnd_bnd"],
    "up_toc_bnd": ["/ancillary_data/land/up_toc_bnd"],
    "up_toc_cut": ["/ancillary_data/land/up_toc_cut"],
    "urban_flag": [
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="A utility to return a list of ICESat-2 granule variables given a set of variable ids."
    )
    parser.add_argument(
        "var_ids",
        type=str,
    ...
    parser.add_argument(
        ...
        metavar="ATLXX",
        default="ATL03",
        help="Short name for the dataset. Default 'ATL03'.",
    )
    parser.add_argument(
        "-separator",
        "-s",
        ...
        type=str,
        default="<newline>",
        help="Separator character for return values (default '<newline>'). For a newline, use '<newline>' (without the quotes). For space, use '<space>'. For any other character, just put the character (no quotes).",
    )
    parser.add_argument(
        "--list_var_ids",
        "-l",
        default=False,
        action="store_true",
        help="List all the dataset variable IDs for the given dataset DATASET_NAME. Overrides var_ids.",
    )
...
if __name__ == "__main__":
    ...
    if args.list_var_ids:
        ...
        print(
            separator.join(
                accrue_variables(args.var_ids, dataset_name=args.dataset_name)
            ),
            end="",
        )
